    ...
    <div>
      <div className="flex w-full custom-scrollbar">
        ...
        <div className="flex flex-col w-full min-h-screen">
          <div className="h-16 w-full bg-green-800 flex items-center justify-center text-white sticky top-0 z-[999] shadow-md gap-5 px-3 ">
            ...
            <h1 className="text-base font-montserrat font-extralight tracking-wide text-center md:text-xl lg:text-xl">
              Welcome to "Smart Agro-Advisory Dissemination System"
            </h1>
          </div>
